...
def main():
    ...
    artifact = {
        ...
        "cluster_strategy": {
            ...
            "thesis": "Build a tightly scoped cluster of practical AI workflow templates for business teams before expanding to new sites or unrelated topics.",
            "selection_model": "risk veto + SEO/GEO classification + evidence availability + existing-site placement fit",
            "current_limitation": "This batch uses strategy-hypothesis long-tail topics; it does not yet include verified keyword volume or trend-source data.",
        },
