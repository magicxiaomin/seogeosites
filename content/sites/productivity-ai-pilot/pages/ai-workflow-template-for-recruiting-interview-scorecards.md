---
title: "Ai Workflow Template For Recruiting Interview Scorecards"
slug: "ai-workflow-template-for-recruiting-interview-scorecards"
...
Use this workflow to draft interview scorecards from approved source material while keeping sensitive data, unsupported claims, and final production decisions under human review. The AI output should be treated as a structured draft, not an autonomous decision.
...
- Job criteria, interview notes, rubric, and approved evaluation criteria
...
- Greenhouse recruiting software official site: https://www.greenhouse.com/ — supports: recruiting workflow context, official product/source context for staging review.
- Workday HCM official site: https://www.workday.com/en-us/products/human-capital-management/overview.html — supports: employee and HR workflow context, official product/source context for staging review.
